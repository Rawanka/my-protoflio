...
<h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl'>Skills</h3>
    ...
    text-gray-500 text-sm'>Hover over to see %</h2>
     <div className='absolute top-56 items-center justify-center h-full space-x-5 text-gray-400 text-xl'>
       <button
     ...
     <div className=' absolute grid grid-cols-4 space-y-4 space-x-3 top-60'>
