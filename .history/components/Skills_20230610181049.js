...
const info = {
  option1: [
    { id: 'web1', skill:'40' ,img: 'This is information for Option 1' },
    { id: 'Info 2', description: 'Additional information for Option 1' },
  ],
  option2: [
    { id: 'Info 3', description: 'This is information for Option 2' },
    { id: 'Info 4', description: 'Additional information for Option 2' },
  ],
  option3: [
    { id: 'Info 5', description: 'This is information for Option 3' },
    { id: 'Info 6', description: 'Additional information for Option 3' },
  ],
};
