...
<h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl'>Skills</h3>
     <h2 className='absolute top-40 uppercase tracking-[4px]
    text-gray-500 text-sm'>Hover over to see %</h2>
     <div className='absolute top-52 items-center justify-center h-full space-x-5 text-gray-400 text-xl'>
       <button
...
<div className=''>
     <div className='grid grid-cols-4 gap-3 md:grid-flow-cols-4 lg:grid-cols-5 justify-start'>
