...
export default function Skill(precent) {

  const skills = [
    {skill:"html", precent :90,},
    {skill:"html", precent :30,},
     {skill:"html", precent :40,},
    ];
        ...
        transition duration-300 ease-in-out'/>
         ...
         <div className='absolute opacity-0 group-hover:opacity-80
          ...
          {skills?.map((precent) => (
            ...
            <p key={precent} className='text-3xl font-bold text-black
            opacity-100'>{precent}</p>
))}
          </div>
