...
<h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl'>Skills</h3>
    ...
    text-gray-500 text-sm'>Hover over to see %</h2>
     ...
     <div className='flex items-center justify-center  gap-3 text-gray-400 text-xl '>
       <button
         className={`option-btn ${selectedOption === 'option1' ? 'active' : ''} rounded-full border border-[#6a38e9] text-white lg:px-4 lg:py-4 px-4 py-2 sm:px-2 sm:py-2`}
         onClick={() => handleOptionClick('option1')}
       >
         Web develop
       </button>
       <button
         className={`option-btn ${selectedOption === 'option2' ? 'active' : ''} rounded-full border border-[#6a38e9] text-white lg:px-4 lg:py-4 sm:px-10 sm:py-6 `}
         onClick={() => handleOptionClick('option2')}
       >
         RPA
       </button>
       <button
         className={`option-btn ${selectedOption === 'option3' ? 'active' : ''} rounded-full border border-[#6a38e9] text-white lg:px-4 lg:py-4 px-2 py-2 sm:px-2 sm:py-2`}
         onClick={() => handleOptionClick('option3')}
       >
         Game develop
       </button>
       <button
         className={`option-btn ${selectedOption === 'option4' ? 'active' : ''} rounded-full border border-[#6a38e9] text-white lg:px-4 lg:py-4 px-2 py-2 sm:px-2 sm:py-2`}
     ...
     <div className='grid grid-cols-4 gap-3 md:grid-cols-4 lg:grid-cols-5 py-9 px-2'>
