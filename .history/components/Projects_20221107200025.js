...
export default function Projects() {
    const projects = [
        {n:1, projeceName:"(freelancing) building Microsoft system",brief:"building a whole system for a private school with Microsoft and set up teams for the class "}, 
