...
<h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl'>Skills</h3>
    ...
    text-gray-500 text-sm'>Hover over to see %</h2>
     ...
     <div className='grid bg-white w-full h-full justify-center align-middle '>

     <div className='grid grid-cols-4 gap-3 md:grid-flow-cols-4 lg:grid-cols-5 bg-white justify-center'>
