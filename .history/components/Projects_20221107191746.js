...
export default function Projects() {
    const projects = [
        {n:1, projeceName:"(freelancing) building teams for private school",brife:"build a whole system for a private school in Microsoft and set up teams for the class "}, 
        {n:2, projeceName:"Airbnb clone",brife:"buildeing Airbnb clone for learning porpese "}, 
        {n:3, projeceName:"Admin Dashborad App",brife:""}
        {n:4, projeceName:"Admin Dashborad App",brife:""}
