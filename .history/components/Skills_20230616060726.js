...
<h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl'>Skills</h3>
    ...
    text-gray-500 text-sm'>Hover over to see %</h2>
     ...
     <div className='flex items-center justify-center  gap-3 text-gray-400 text-xl '>
       <button
         className={`option-btn ${selectedOption === 'option1' ? 'active' : ''} rounded-full border border-[#6a38e9] text-white lg:px-2 lg:py-4 px-4 py-2 sm:px-2 sm:py-2`}
         onClick={() => handleOptionClick('option1')}
       >
         Web develop
       </button>
       <button
         className={`option-btn ${selectedOption === 'option2' ? 'active' : ''} rounded-full border border-[#6a38e9] text-white lg:px-2 lg:py-4 sm:px-7 sm:py-6 `}
       ...
       <button
         className={`option-btn ${selectedOption === 'option4' ? 'active' : ''} rounded-full border border-[#6a38e9] text-white lg:px-2 lg:py-4 px-2 py-2 sm:px-2 sm:py-2`}
