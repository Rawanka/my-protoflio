    ...
    mx-auto items-center'>
     ...
     text-gray-500 text-2xl'>About
                ...
                <span className='text-center text-xs space-y-4 md:text-left md:space-y-6 md:px-8 md:text-lg'>
                    <p> 
                    I'm Rawan, a recent graduate from Taibah University with a Bachelor's degree in Business. Despite my major, I've always had a strong interest in technology and taught myself to code through online bootcamps, starting with HTML, CSS, and Javascript.
