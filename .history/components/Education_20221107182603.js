...
export default function Education() {
    const educations = [
        {education:"Associate degree in office management",by:"taibah"},
        {education:"Bechelor of science in Business Adminstration",by:""},
        {education:"The Complete 2022 Web Development Bootcamp",by:"Dr.angial"},
      ];
