            ...
            <div className=' relative w-full flex overflow-x-scroll 
             overflow-y-hidden snap-x snap-mandatory z-20 scrollbar'>
                {projects.map((projeceName,brife, i) => (
                    ...
                    <div key={projects.length} className='snap-start w-screen flex-shrink-0 flex flex-col space-y-5 items-center justify-center p-20 md:p-40'>
                        ...
                        <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
                            <h4 className='text-4xl font-semibold text-center'>{projeceName}
                                <span className='underline decoration-white/50'> project {i + 1} of {projects.length}</span>
                            </h4>
