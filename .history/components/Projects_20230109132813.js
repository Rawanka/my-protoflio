...
export default function Projects() {
    const projects = [
        ...
        { n: 2, projeceName: "build portfolio", brief: "building this portfolio by next js, tailwindcss, and other libraries " },
    ...
    return (
        <div className='h-screen flex flex-row relative text-center md:flex-row lg:text-left justify-evenly mx-auto items-center p-10'>
            ...
            <div className='w-full absolute top-[35%] bg-blue-900/10 left-0 h-[200px] -skew-y-12' />
        </div>
    )
}