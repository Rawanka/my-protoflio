...
export default function Skill({ skill, img }) {
  return (
    <div className='top-20 group relative flex cursor-pointer justify-center h-24 w-24 md:w-28 md:h-28 xl:w-32 xl:h-32'>
      <motion.img
        initial={{
          opacity: 0,
        }}
      ...
      <div className='absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-gray-100  rounded-full z-0'>
