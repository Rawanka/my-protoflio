...
export default function Skill({ skill, img }) {
  return (
    ...
    <div className='top-20 flex relative group cursor-pointer bg-white'>
      ...
      <div className=' absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-gray-100 w-24 h-4 md:w-28 md:h-28 xl:w-32 rounded-full z-0'>
