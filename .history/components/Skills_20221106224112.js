...
export default function Skills() {
  ...
  const skills = [
  {skill:"32",img:"https://www.kindpng.com/picc/m/485-4850314_transparent-background-html-logo-hd-png-download.png" alt="Transparent Background Html Logo, HD Png Download@kindpng.comQ"},
