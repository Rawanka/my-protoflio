...
export default function Projects() {
    const projects = [
        ...
        {n:2, projeceName:"",brife:""}, 
        {n:3, projeceName:"",brife:""}
    ]
            ...
            <div className=' relative w-full flex overflow-x-scroll 
             overflow-y-hidden snap-x snap-mandatory z-20 scrollbar'>
                {projects.map(({projeceName,brife,i}) => (
                    ...
                    brife={brife}
                     className='snap-start w-screen absolute flex flex-col space-y-5 items-center justify-center p-20 md:p-40 lg:p-40'>
                        ...
                        <div className='space-y-10 px-0 md:px-10 max-w-6xl text-center relative
                        '>
