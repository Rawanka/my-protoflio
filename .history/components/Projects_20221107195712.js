            ...
            <div className=' relative w-full flex overflow-x-scroll 
             overflow-y-hidden snap-x snap-mandatory z-20 scrollbar'>
                {projects.map(({projeceName,brief,i}) => (
                    ...
                    brife={brief}
                     className='snap-start w-screen flex-shrink-0 flex flex-col space-y-5 items-center justify-evenly p-20 md:p-40 lg:p-40'>
                        ...
                        <div className='space-y-6 px-0 md:px-10 max-w-6xl text-center justify-center'>
